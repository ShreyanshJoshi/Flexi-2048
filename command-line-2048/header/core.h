...
/** @brief Assigns either 2 or 4 randomly on a cleared out board
 */
void initialize_game(int a[4][4]);

/** @brief Displays the current state of the board on terminal, along with the points.
 */
...
/** @brief Calculates the score/points after a move is made.
 */
